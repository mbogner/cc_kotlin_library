...
sonarqube {
    properties {
        ...
        property("sonar.projectKey", "library::{{cookiecutter.project_name}}")
    ...
    publications {
        create<MavenPublication>("maven") {
            ...
            pom {
                ...
                scm {
                    url.set("https://github.com/mbogner/library-{{cookiecutter.project_name}}")
                    connection.set("git@github.com:mbogner/library-{{cookiecutter.project_name}}.git")
                    developerConnection.set("git@github.com:mbogner/library-{{cookiecutter.project_name}}.git")
                }
                developers {
                    developer {
                        id.set("mbo")
